...
describe('the configure module', () => {
    ...
    it('should add credentials when none are found', async () => {
      ...
      it('should add an account', async () => {
        ...
        await configure.account('twittercli-test')
      ...
      after(async () => {
        ...
        await fs.unlink(path.join(process.env.HOME, '.config', 'configstore', 'twittercli-test.json'))
    })
})
